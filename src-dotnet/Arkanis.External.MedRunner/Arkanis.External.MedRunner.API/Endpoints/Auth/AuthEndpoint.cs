namespace Arkanis.External.MedRunner.API.Endpoints.Auth;
...
/// </summary>
public class AuthEndpoint(ApiConfig config, ITokenProvider tokenProvider, ILogger logger) : ApiEndpoint(config, tokenProvider, logger)
{
